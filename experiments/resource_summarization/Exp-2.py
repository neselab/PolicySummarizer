...
policy_folder = REPO_ROOT / "Dataset" / "Dataset_mutated"
quacky_base_path = QUACKY_DIR
quacky_path = QUACKY_DIR / "quacky.py"
working_directory = QUACKY_DIR
response_file_path = QUACKY_DIR / "response.txt"
result_table_path = SCRIPT_DIR / "multi-string.csv"
generated_policy_path = QUACKY_DIR / "gen_pol.json"
p1_not_p2_models_path = QUACKY_DIR / "P1_not_P2.models"
progress_file_path = SCRIPT_DIR / "progress.json"
