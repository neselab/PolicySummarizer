...
fine_tuning_dataset_path = "experiments/fine_tuning/fine-tuning-v2/fine_tuning_dataset.jsonl"
progress_file_path = "experiments/fine_tuning/fine-tuning-v2/progress.json"
