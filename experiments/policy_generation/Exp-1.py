...
QUACKY_DIR = REPO_ROOT / "policysummarizer" / "quacky"

policy_folder = REPO_ROOT / "Dataset"
quacky_base_path = QUACKY_DIR
quacky_py_path = QUACKY_DIR / "quacky.py"
working_directory = QUACKY_DIR
response_file_path = QUACKY_DIR / "response.txt"
response2_file_path = QUACKY_DIR / "response2.txt"
result_table_path = SCRIPT_DIR / "single_policy_dual_analysis.json"
generated_policy_path = QUACKY_DIR / "gen_pol.json"
smt_output_1_path = QUACKY_DIR / "output_1.smt2"
smt_output_2_path = QUACKY_DIR / "output_2.smt2"
progress_file_path = SCRIPT_DIR / "single_policy_dual_progress.json"
results_list_path = SCRIPT_DIR / "single_policy_dual_analysis.json"
...
if __name__ == "__main__":
    ...
    # This is crucial if result_table_path and progress_file_path are relative like "experiments/policy_generation/file.json"
